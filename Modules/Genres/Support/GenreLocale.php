...
namespace Modules\Genres\Support;

/**
 * Localized display fields (uses app locale from global-localization / middleware).
 */
final class GenreLocale
{
    ...
    /**
     * Stored path or filename for the genre image.
     *
     * @param  object|null  $row  Model with optional file_url
     */
    public static function fileUrl(?object $row): ?string
    {
        if ($row === null) {
            return null;
        }
